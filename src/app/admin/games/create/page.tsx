...
export default function CreateGamePage() {
  ...
  useEffect(() => {
    // Check if sport is specified in URL params
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Create boxes for the game manually
      const boxes = [];
      ...
      <div className="bg-white dark:bg-gray-800 shadow rounded-lg">
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="flex space-x-4">
                <label className="flex items-center">
                  <input
                    ...
                    className="mr-2"
                  />
                  <span className="text-sm text-gray-700 dark:text-gray-300">🏈 NFL</span>
                </label>
                <label className="flex items-center">
                  <input
                    type="radio"
                    ...
                    className="mr-2"
                  />
                  <span className="text-sm text-gray-700 dark:text-gray-300">🏀 NBA</span>
                </label>
              </div>
            </div>
            ...
            {/* Game Date */}
            <div>
              <label htmlFor="gameDate" className="block text-sm font-medium text-gray-700 dark:text-gray-300">
                Game Date & Time
              </label>
              <input
                type="datetime-local"
            ...
            {/* Entry Fee */}
            <div>
              <label htmlFor="entryFee" className="block text-sm font-medium text-gray-700 dark:text-gray-300">
          ...
          <div className="bg-gray-50 dark:bg-gray-900 rounded-lg p-4">
            <h3 className="text-sm font-medium text-gray-900 dark:text-white mb-3">Prize Structure Preview</h3>
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
              <div className="text-center">
                <div className="font-medium text-gray-900 dark:text-white">1st Quarter</div>
                <div className="text-indigo-600 dark:text-indigo-400">{Math.floor(entryFee * 100 * 0.9 * 0.25)} HC</div>
              </div>
              <div className="text-center">
